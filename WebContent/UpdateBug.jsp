...
<html>
  <head>
	...
	<script type="text/javascript" language="javascrpt" src="dateget.js">
    	function check()
    	{
    		...
    		if(testerForm.bug_rectified.value=='')
    		{
    			window.alert("Bug Rectified Date is empty !");
    			return false;
    		}
...
<h3><font color="Green" face="arial narrow">&nbsp;&nbsp;&nbsp;&nbsp;Update Bug</font></h3>
...
%>
		...
		<tr><td align="right"><font>Priority</font></td><td><input type="text" name="priority" value="<%=rs.getString(5)%>"></td></tr>
  		...
  		<tr><td align="right"><font>Tester Status</font></td><td> <input type="text" name="status" value="<%=rs.getString(10)%>"></td></tr>
  		<tr><td align="right"><font>Rectified Date</font></td><td> <input type="text" name="bug_rectified" ></input>
  		<a href="javascript:show_calendar('document.testerForm.bug_rectified', document.testerForm.bug_rectified.value);">date</a> 
  		</td></tr> 
...
catch(Exception e)
{
 ...
 %>  	
  		<tr><td align="right"><font>Bug Status</font></td><td> 
  		<select name="status1">
