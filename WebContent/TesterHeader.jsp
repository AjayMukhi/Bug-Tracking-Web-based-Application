<html>
<form>
	<table style="background-color:#336666;" width="100%">
	<tr>
                ...
                <b>[ <%if(role.equals("admin")){
                      %><a href="./AdminHome.jsp"><%
                        ...
                        %><a href="./TesterHome.jsp?cat=Tester"><%
                            ...
                            %><a href="./DeveloperHome.jsp?cat=Developer&uname=<%=uname%>"><%
                       }else if(role.equals("HRManager")){
                          %><a href="./ManagerHome.jsp?cat=HrManager&uname=<%=uname%>"><%
...
<font size="3px">
  ...
  <li><a href="#">Open</a>
  <ul id="nav">
       <li><a href="./AssignBug.jsp?cat=Tester">Add/Assign Bug </a></li>
