...
<form  name="editform" action="./Reg">
	<table style="background-color:#696969;" width="100%">
	<tr>
...
<tr><td><b><input type="submit" name="sub" value="Register" style="background-color:#778899" onclick="return validate()">
<b><input type="Reset" name="reset" value="Reset" style="background-color:#778899" ></td></tr>
</center>
</form>
</body>
