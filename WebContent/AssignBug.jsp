	...
	<script type="text/javascript" language="javascrpt">
    	function check()
    	{
    	   ...
    	   if(testerForm.bug_name.value=='')
    		...
    		if(testerForm.bug_type.value=="select")
    		{
    			window.alert("Bug Type is empty !");
    			return false;
    		}
    		if(testerForm.bug_level.value=="select")
    		{
    			window.alert("Bug Level is empty !");
    			return false;
    		}
    		if(testerForm.priority.value=="select")
    		{
...
%>
  	...
  	<h3><font color="Green">&nbsp;&nbsp;&nbsp;&nbsp;Add and Assign Bug</font></h3>
  	<table border="0" cellpadding="2" >
  	    <tr><td align="right"><font>Bug_Name</font></td><td>
  	    <input type="text" name="bug_name"></td></tr>
  		
  		<tr><td align="right"><font>Bug_type</font></td><td>
  		...
  		<tr><td align="right"><font>Bug_level</font></td><td>
		...
		<tr><td align="right"><font>Priority</font></td><td>
