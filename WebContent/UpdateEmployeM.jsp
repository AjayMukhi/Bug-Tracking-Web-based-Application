...
int DisRow=0;
	...
	<tr class= <%=(DisRow%2!=0)? "row_even" : "row_odd"%>>
		...
		<tr><td align="center">Employee Name:</td><td><input type="text"value=<%=fname%><%=lname %> name="empname" ></td></tr>
		<tr><td align="center">Gender:</td><td><input type="text"value=<%=gender%> name="gender" ></td></tr>
		<tr><td align="center">Date of Birth</td><td><input type="text"value=<%=dob%> name="dob" ></td></tr>
		<tr><td align="center">Qualification:</td><td><input type="text"value=<%=qualification%> name="qualification" ></td></tr>
		<tr><td align="center">Address:</td><td><input type="text"value=<%=address%> name="address" ></td></tr>
		<tr><td align="center">PhoneNo</td><td><input type="text"value=<%=phoneno%> name="phoneno" ></td></tr>
		<tr><td align="center">MobileNo:</td><td><input type="text"value=<%=mobileno%> name="mobileno" ></td></tr>
		<tr><td align="center">EmailId:</td><td><input type="text"value=<%=emailid%> name="emailid" ></td></tr>
		<tr><td align="center">Date Of Joining:</td><td><input type="text"value=<%=doj%> name="doj" ></td></tr>
		<tr><td align="center">Role:</td><td><input type="text"value=<%=role%> name="role" ></td></tr>
...
<br>
<br>
<center><input type="submit"value="Update" style="background-color:#778899" onClick="return validate()"></center>
</form>
</BODY>
